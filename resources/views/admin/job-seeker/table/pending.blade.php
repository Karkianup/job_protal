                                      ...
                                      <div class="drodown">
                                          ...
                                          <div class="dropdown-menu dropdown-menu-end">
                                              <ul class="link-list-opt no-bdr">
                                                  ...
                                                  <li><a href="{{ route('admin.jobSeeker.show',$jobSeeker->id) }}"><em class="icon ni ni-eye"></em><span>View
                                                              Details</span></a></li>
                                                  <li><a data-bs-toggle="modal" data-bs-target="#modalDefault"><em
                                                              class="icon ni ni-repeat"></em><span>Approve</span></a>
                                                  </li>
                                                  <li><a class="deleteButton" data-id="{{ $jobSeeker->id }}"><em
