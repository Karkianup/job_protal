...
@section('content')
    ...
    <div class="card card-bordered card-preview">
        <div class="card-inner">
            ...
            <span class="preview-title-lg overline-title">Update User</span>
            <div class="preview-block">
                ...
                @endif
                <form class="form-validate" method="POST" action="{{ route('admin.user.update',$user->id) }}">
                    @csrf
                    @method('put')
                    <div class="row gy-4">
                        <div class="col-sm-6">
