                            ...
                            <ul class="nk-menu">
                                ...
                                <li class="nk-menu-item">
                                    <a href="html/crm/index.html" class="nk-menu-link">
                                        ...
                                        <span class="nk-menu-text">CRM Panel</span><span
                                ...
                                <li class="nk-menu-item">
                                    <a href="html/hotel/index.html" class="nk-menu-link">
                                        ...
                                        <span class="nk-menu-text">Hotel Management</span><span
                                            class="nk-menu-badge">HOT</span>
                                    </a>
                                </li><!-- .nk-menu-item -->
                                <li class="nk-menu-heading">
                                ...
                                <li class="nk-menu-item has-sub">
                                    <a href="#" class="nk-menu-link nk-menu-toggle">
                                        <span class="nk-menu-icon"><em class="icon ni ni-user-list"></em></span>
                                        <span class="nk-menu-text">Customers</span><span
                                            class="nk-menu-badge">New</span>
                                    </a>
                                    <ul class="nk-menu-sub">
                                        <li class="nk-menu-item">
                                    ...
                                    <ul class="nk-menu-sub">
                                        ...
                                        <li class="nk-menu-item">
                                            <a href="#" class="nk-menu-link nk-menu-toggle"><span
                                                    class="nk-menu-text">Classic Version - v2</span><span
                                    ...
                                    <ul class="nk-menu-sub">
                                        ...
                                        <li class="nk-menu-item">
                                            <a href="html/components/tables/table-datatable.html"
                                                class="nk-menu-link"><span class="nk-menu-text">DataTables</span>
                                    ...
                                    <ul class="nk-menu-sub">
                                        ...
                                        <li class="nk-menu-item">
                                            <a href="html/components/forms/input-group.html"
                                                class="nk-menu-link"><span class="nk-menu-text">Input Group</span>
                                                <span class="nk-menu-badge">New</span></a>
                                        </li>
                                        <li class="nk-menu-item">
                                        ...
                                        <li class="nk-menu-item">
                                            <a href="html/components/forms/nouislider.html" class="nk-menu-link"><span
                                                    class="nk-menu-text">noUiSlider</span> <span
                                                    class="nk-menu-badge">New</span></a>
                                        </li>
                                        <li class="nk-menu-item">
                                                ...
                                                <div class="card-inner-group">
                                                    <div class="card-inner">
                                                        <div class="user-card user-card-s2">
                                                            ...
                                                            <div class="user-info">
                                                                <div class="badge bg-light rounded-pill ucap">Platinam
                                                                </div>
                                                    ...
                                                    <div class="card-inner">
                                                        ...
                                                        <div class="row g-3">
                                                            ...
                                                            <div class="col-sm-6 col-md-4 col-lg-12">
                                                                ...
                                                                <span>551 Swanston Street, Melbourne <br /> Victoria
                                                                    3053 Australia</span>
                                                            </div>
                                                            <div class="col-sm-6 col-md-4 col-lg-12">
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div class="d-flex align-items-center">
                                                                                ...
                                                                                <div class="ms-3">
                                                                                    ...
                                                                                    <span class="sub-text">Expires Nov
                                                                                        2023</span>
                                                                                </div>
                                                                            </div>
                                                                            <ul
                                                                                ...
                                                                                <div class="ms-3">
                                                                                    <h6 class="lead-text">American
                                                                                        Express <span
                                                                                            class="text-soft ml-1">****
                                                                                            4352</span></h6>
                                                                                    <span class="sub-text">Expires Feb
                                                                                        2024</span>
                                                                                </div>
                                                                            </div>
                                                                            <ul
                                                                    ...
                                                                    <div class="media media-center gx-3 wide-xs">
                                                                        ...
                                                                        <div class="media-content">
                                                                            <p>You can connect with your google account.
                                                                                <em class="d-block text-soft">Not
                                                                                    connected yet</em>
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                                        ...
                                                        <div class="nk-block-head nk-block-head-sm">
                                                            <div class="nk-block-head-content">
                                                                <h6 class="nk-block-title">Import Contacts <a
                                                                        href="#"
                                                                        class="link link-primary ms-auto">Import from
                                                                        Google</a></h6>
                        ...
                        <div class="row gy-3 gx-3">
                            ...
                            <div class="col-7">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control form-control-lg" id="exp-date"
                                        placeholder="MM/YYYY">
                                </div>
                            </div>
                            <div class="col-5">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control form-control-lg" id="cvv/cvc"
                                        value="" placeholder="CVV/CVC">
                                </div>
                            </div>
                            <div class="col-12">
                                <ul class="align-center flex-wrap flex-sm-nowrap gx-4 gy-2">
                                    <li>
                                        <a href="#" class="btn btn-lg btn-primary" data-bs-dismiss="modal">Add
                                            Card</a>
                                    </li>
                                </ul>
                            </div>
